...
p4a_test1 = TestCase (assertEqual ("sumTree "++(show HW2.myTree)) 32 (sumTree HW2.myTree) )
t1_output = NODE 32 (NODE 15 (NODE 9 (LEAF 4) (LEAF 5)) (LEAF 6)) (NODE 17 (LEAF 8) (LEAF 9))
p4b_test1 = TestCase (assertEqual ("createSumTree "++ (show HW2.myTree)) (t1_output) (createSumTree HW2.myTree) )

p5_test1 = TestCase (assertEqual ("foldListTree (++) \"\" " ++ (show HW2.t5)) "School-of-Electrical-Engineering-and-Computer-Science-WSU" (foldListTree (++) "" HW2.t5) )
p5_test2 = TestCase (assertEqual ("foldListTree (++) \"\" "++ (show HW2.t5)) "School-of-Electrical-Engineering-and-Computer-Science-WSU" (foldListTree (++) "" HW2.t5) )
