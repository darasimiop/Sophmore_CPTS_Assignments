...
p1_test5 = TestCase (assertEqual "(exists [2] [[4] [6]])" False  (exists [2] [[4],[6]]) )
p1_test6 = TestCase (assertBool "exists 1 [6,7,9]"  (exists 1 [6,7,9]) )
...
p2_test4 = TestCase (assertEqual "listUnion [2,4,5] [3,4,5,6]"  (sort [2,3,4,5,6])  (sort (listUnion [2,4,5] [3,4,5,6])) )
p2_test5 = TestCase (assertEqual "listUnion [[2,3],[3,4]] [[2],[3,4],[3,4]]"  (sort [[2,3],[2],[3,4]])  (sort (listUnion [[2,3],[3,4]] [[2],[3,4],[3,4]] ) ) )
...
p3_test4 = TestCase (assertEqual "replace 0 'Y' \"abcd\""  "Ybcd" (replace 0 'Y' "abcd") )
p3_test5 = TestCase (assertEqual "replace 7 6 [1,2,3,4,7]" [1,2,3,4,7] (replace 5 6 [1,2,3,4,7]))
